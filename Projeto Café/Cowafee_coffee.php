...
<body>
    ...
    <div class="tittle-text">
    	<hr>
    		<p class="text-sm-center coffee">Coffee > Cowafee Coffee > 250g</p>
    	<hr>
    </div>
	    ...
	    <div class="comments2">
	    	<div class="background-box">
	    		<div>
	    			...
	    			<div class="evaluation-stars">
	    				<img class="evaluation-comment" width="15px" src="Images/star.png">
	    				<img class="evaluation-comment2" width="13px" src="Images/star.png">
	    				<img class="evaluation-comment2" width="13px" src="Images/star.png">
	    				<img class="evaluation-comment2" width="15px" src="Images/star.png">
	    				<img class="evaluation-comment2" width="13px" src="Images/star-white2.png">
	    			</div>
	    		<p class="text-comment">Café é saboroso, porém, achei que podia melhorar mais</p>
	    		</div>
	    	</div>
	    </div>	
	    <!--End box comment-->
