...
<body>
    ...
    <div class="tittle-text">
    	<hr>
    		<p class="text-sm-center coffee">Coffee > Between Coffee > 250g</p>
    	<hr>
    </div>
    ...
    <div>
	    ...
	    <div class="comments">
	    	...
	    	<div class="background-box">
	    		...
	    		<p class="text-comment">Será que o "pó" do café que eu procuro está por aqui?</p>
	    		</div>
	    	</div>
	    </div>	
	    <!--End box comment-->
