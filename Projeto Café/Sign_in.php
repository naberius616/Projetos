...
<head>
	...
	<link rel="stylesheet" type="text/css" href="Sign_in.css" media="screen" />
	        ...
	        <div class="container">
	          ...
	          <div class="collapse navbar-collapse" id="nav-principal">
	            <ul class="navbar-nav ml-auto" style="">
	              <li class="nav-item">
	              <li class="nav-item">
	                <a href="/Sign_up.php" class="btn btn-sign-up ml-4"><i class="bi bi-door-closed"></i>Sign up</a>
	              </li>
	              <li class="nav-item">
	                <a href="" class="btn btn-sign-in ml-4 disabled"><i class="bi bi-door-open"></i>Sign in</a>
	              </li>
	            </ul>
	          </div>
	        </div>
	    	...
	    	<div class="row">
	    		<div id="box-register">
	    			<form method="POST" action="">
	    				<h1 class="text-center sign-in-text">Sign in</h1>
	    				<p class="email-text">Email</p>
	    				<input class="inpt1" type="text" name="email" placeholder="Put your Email">

	    				<p class="password-text">Password</p>
	    				<input class="inpt1" type="password" name="password" placeholder="Put your password">

	    				<button class="btn btn-confirm-sign-in" type="submit">Sign in</button>
	    			</form>

				<?php
				if( isset($_POST["email"]) AND isset($_POST["password"]) ){
					include "/home/kali/Desktop/Mqn/html/pdo.php";
					...
					if( $line = mysqli_fetch_assoc($data) ){
						...
						header ('Location:Sign_in.php?error=login_or_password_not_found');
