...
<body>
    ...
    <div class="tittle-text">
    	<hr>
    		<p class="text-sm-center coffee">Coffee > Binary Coffee > 250g</p>
    	<hr>
    </div>
    ...
    <div class="stars_evaluation">
    		...
    		<img width="15px" src="Images/star.png">
    		<img width="15px" src="Images/star.png">
    		<img width="13px" src="Images/star.png">
    </div>
    ...
    <div>
	    ...
	    <div class="comments">
	    	...
	    	<div class="background-box">
	    		...
	    		<p class="text-comment">Esse é bom rapaz, tá maluco 👌</p>
	    		</div>
	    	</div>
	    </div>	
	    <!--End box comment-->
	    ...
	    <div class="comments2">
	    	<div class="background-box">
	    		...
	    		<p class="text-comment">MUITO BOM! Esse café é simplesmente perfeito</p>
	    		</div>
	    	</div>
	    </div>	
	    <!--End box comment-->
	    ...
	    <div class="comments2">
	    	<div class="background-box">
	    		...
	    		<marquee><p class="text-comment">XSS ARRUMEMMM</p></marquee>
	    		</div>
	    	</div>
	    </div>	
	    <!--End box comment-->
