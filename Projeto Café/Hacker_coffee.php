...
<body>
    ...
    <div class="tittle-text">
    	<hr>
    		<p class="text-sm-center coffee">Coffee > Hacker Coffee > 250g</p>
    	<hr>
    </div>
    ...
    <div>
	    ...
	    <div class="comments2">
	    	<div class="background-box">
	    		...
	    		<p class="text-comment">Café muito amargo, deixou a desejar!</p>
	    		</div>
	    	</div>
	    </div>	
	    <!--End box comment-->
	    ...
	    <div class="comments2">
	    	<div class="background-box">
	    		...
	    		<marquee><p class="text-comment">XSS armazened pae é brabo</p></marquee>
	    		</div>
	    	</div>
	    </div>	
	    <!--End box comment-->
